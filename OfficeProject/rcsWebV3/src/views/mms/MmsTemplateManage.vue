    ...
    <section class="mms-template wrap-container">
        <el-form :inline="true" :model="params" size="small">
            <el-form-item label='标题'>
                <el-input v-model="params.subject" placeholder="请输入标题"></el-input>
            </el-form-item>
        ...
        <section>
            ...
            <el-table :data="templateList" fit v-loading="tableLoading" size="small" border ref="multiplePushTable"
                ...
                <el-table-column prop="mmsId" label="消息Id" align="center"></el-table-column>
                <el-table-column prop="subject" label="标题" align="center"></el-table-column>
