        ...
        <el-form :inline="true" :model="params" size="small">
            ...
            <el-form-item>
                ...
                <el-button type="primary"
                    @click="dialogVisible=true;dialogTitle='新建音频';dialogForm={groupId:catalogIdSelect}" v-if="scene==1">
                    新建音频</el-button>
            </el-form-item>
            ...
            <el-form ref="form" :model="dialogForm" label-width="80px" size="small">
                ...
                <el-form-item label="内容" class="is-required">
                    <upload-file-base v-if="dialogVisible" ref="audioUpload"
                        accept="audio/mp3,audio/m4a,audio/amr,audio/mpeg" :limit="1" folderType="audio" :fileSize="5"
                        tip="音频大小不超过5M，.mp3、.m4a、.amr、mpeg格式，最大90秒"></upload-file-base>
                </el-form-item>
                <el-form-item label="封面">

                    <upload-file-base v-if="dialogVisible" ref="audioUploadImg" accept="image/jpeg,image/png,image/jpg"
                        :limit="1" folderType="audio" :fileSize="0.2"
