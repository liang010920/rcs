<template>
    <section class="video-resource resource-manage">
        <el-form :inline="true" :model="params" size="small">
            ...
            <el-form-item>
                ...
                <el-button type="primary"
                    @click="dialogVisible=true;dialogTitle='新建视频';dialogForm={groupId:catalogIdSelect}" v-if="scene==1">
                    新建视频</el-button>
            </el-form-item>
        ...
        <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="35%" center :close-on-click-modal="false">
            <el-form ref="form" :model="dialogForm" label-width="80px" size="small">
                <el-form-item label="内容" class="is-required">
                    <upload-file-base v-if="dialogVisible" ref="videoUpload" accept="video/mp4,video/webm" :limit="1"
                        folderType="video" :fileSize="10" tip="视频大小不超过10M，.mpeg4、.webm格式，最长90秒"></upload-file-base>
                </el-form-item>
                <el-form-item label="封面">
                    <upload-file-base v-if="dialogVisible" ref="videoUploadImg" accept="image/jpeg,image/png,image/jpg"
                        :limit="1" folderType="video" :fileSize="0.2"
                        tip="图片大小不超过0.2MB，支持jpg/jepg、png格式,图片大小建议：400*200"></upload-file-base>
                </el-form-item>
        ...
        <div class="page-wrap">
            <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                :current-page="page.curPage" :page-sizes="[12, 16, 20, 32]" :page-size="page.size"
