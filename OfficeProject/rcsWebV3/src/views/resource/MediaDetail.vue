<template>
    <section class="template-detail wrap-container">
        <el-form ref="form" :model="form" label-width="120px" size="small">
            ...
            <el-card class="box-card">
              ...
              <div class="text item">
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-form-item label="模板名称" class="is-required templateWidth">
                            <el-input v-model="form.name" maxlength="20" width="40%" show-word-limit placeholder="请输入模板名称"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="选择模板分组" class="templateWidth">
                            <div>
                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="支持回落">
                            <div class="huiluo">
                                <div>
                                    <el-switch v-model="rollback"></el-switch>
                                    <el-tooltip class="item" effect="dark" content="" placement="top-start">
                                        <div slot="content" style="width: 210px;line-height: 1.5">
                                            当接收手机不支持5G消息时候，系统自动转换成普通短信下发给该手机，
                                            该功能需要运营商网关支持；如果运营商网关不支持回落，请将不支持
                                            回落的号码导出通过另外普通短信渠道发送
                                        </div>
                    ...
                    <div v-if="rollback">
                        <el-col :span="8">
                            <el-form-item label="回落类型" prop="fallbackSupportedType" class=" templateWidth">
                                <el-select v-model="fallbackSupportedType" placeholder="请选择">
                                    <el-option label="视频短信" :value="1"></el-option>
                                    <el-option label="普通短信" :value="2"></el-option>
                                </el-select>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="回落内容">
                                <div v-if="mmsContent.length <= 0">
                                    <el-button @click="mmsDialogFlag=true">选择回落内容</el-button>
                                </div>
                                <div v-else>
                                    <el-tag :key="tag" v-for="tag in mmsContent" closable :disable-transitions="false"
                                        @close="mmsContentClose(tag)">
                                        {{tag.mmsId}}
                                    </el-tag>
            ...
            <el-form-item label="模板内容" class="is-required">
                ...
                <section v-show="form.groupType == 'TEMPLATE_CARD'" class="card">
                    ...
                    <el-carousel :interval="4000" type="card" :autoplay="false">
                        <el-carousel-item v-for="(card,index) in cardList" :key="'card'+index" align="center">
                          <div class="card-item">
                                              ...
                                              <div class="box">
                                                  <div class="uploadFile">
                                                      ...
                                                      <div v-else-if="types[index]=='RESOURCE_IMAGE'" class="file-wrap card">
                                                          <el-image :src="images[index] | imgPath('image')"
                                                              style="width: 100%;height: 100%" fit="cover"></el-image>
                                                          <i class="del-res theme-color-danger el-icon-error"
                                                              @click="delFiles(index)"></i>
                                                      </div>
                                                      ...
                                                      <div v-else-if="types[index]=='RESOURCE_VIDEO'" class="file-wrap video">
                                                          <video width="100%" height="150px" controls controlslist="nodownload"
                                                              ref="video" disablePictureInPicture
                                                              :src="files[index] | imgPath('video')"
                                                  ...
                                                  <div class="cardTitle">
                                                      <el-input v-model="card.name" maxlength="64" show-word-limit
                                                          placeholder="卡片标题(必填)"></el-input>
                                                  </div>
                                                      ...
                                                      <div class="suggest-container">
                                                          <div class="suggest-item" v-for="(suggest,index) in card.buttonList"
                                                              ...
                                                              <div class="btn-hover" @dragstart="dragStart2(index)"
                                                                  @dragover.prevent="dragOver2(index,card.buttonList)"
                                                                  draggable="true">
                                                          ...
                                                          <div class="cardFont"
                                                              @click="dialogVisibleSuggest = true;suggestButton={type:1};suggestFlag=-1;dialogTitle='按钮';activeCard=card"
                                  ...
                                  <div class="divider" align="center">
                                      ...
                                      <i @click="sortCard(index,1)" v-if="index!=0"
                                          class="el-icon-top theme-color"></i>
                                      <i @click="sortCard(index,-1)" v-if="index!=cardList.length-1"
                                          class="el-icon-bottom theme-color"></i>
                                  </div>

                                  <div @click="delCard(index)" v-if="index != 0" class="del"><i class="el-icon-error"></i></div>
                          </div>
                        </el-carousel-item>
                      </el-carousel>
                    <div v-show="cardList.length<maxCardSize" class="add-card" align="center">
                                    ...
                                    <div class="box">
                                        <div class="uploadFile">
                                            <div v-if="images.length==0"
                                                @click="mediaSelectResourcs();resourceType='RESOURCE_IMAGE'"
                                                class="uploadAdd el-icon-plus"></div>
                                            <div v-if="images.length==0" class="addSuCai">添加图片素材</div>
                                            <div v-else class="file-wrap image">
                                                <el-image :src="images[0] | imgPath('image')"
                                                    style="width: 100%;height: 100%" fit="cover"></el-image>
                                                <i class="del-res theme-color-danger el-icon-error"
                                                    @click="delFiles"></i>
                                            </div>
                            ...
                            <div class="preview">
                                ...
                                <div class="mobile-main scrollbar">
                                    <div class="box">
                                        <div class="uploadFile">
                                            <div v-if="images.length==0"
                                                @click="mediaSelectResourcs();resourceType='RESOURCE_AUDIO'"
                                                class="uploadAdd el-icon-plus"></div>
                            ...
                            <div class="preview">
                                ...
                                <div class="mobile-main scrollbar">
                                    <div class="box">
                                        <div class="uploadFile">
                                            <div v-if="images.length==0"
                                                @click="mediaSelectResourcs();resourceType='RESOURCE_VIDEO'"
                                                class="uploadAdd el-icon-plus"></div>
                                            <div v-if="images.length==0" class="addSuCai">添加视频素材</div>
                                            <div v-else class="file-wrap image">
                                                <video width="100%" height="292" controls controlslist="nodownload"
                                                    ref="video" disablePictureInPicture
                                                    :src="files[0] | imgPath('video')"
                                                    :poster="images[0] | imgPath('video')"></video>
                                                <i class="del-res theme-color-danger el-icon-error"
                                                    @click="delFiles"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="box">
                                        <div class="uploadFile">
                                            <div v-if="files.length==0"
                                                @click="mediaSelectResourcs();resourceType='RESOURCE_DOCMENT'"
                                                class="uploadAdd el-icon-plus"></div>
            ...
            <el-form-item label="建议回复">
                <div class="suggest-container">
                    ...
                    <div class="suggest-add"
                        @click="dialogVisibleSuggest = true;suggestButton={type:1};suggestFlag=-1;dialogTitle='建议回复'"
                        v-show="suggestList.length<11">
        ...
        <!-- 回落内容 start-->
        <el-dialog title="回落内容" :visible.sync="mmsDialogFlag" width="80%" class="mmsTaskManageHeight" center
            :close-on-click-modal="false">
            <mms-template-manage v-if="mmsDialogFlag" :scene="2" @mmsContentInfo="mmsContentInfo"></mms-template-manage>
        </el-dialog>
        <!-- 回落内容 end -->

        <!--建议回复start-->
        <el-dialog :title="dialogTitle" :visible.sync="dialogVisibleSuggest" width="50%" center
            :close-on-click-modal="false">
            ...
            <el-form ref="form" :rules="rules" :model="suggestButton" label-width="120px" size="small">
                ...
                <el-form-item label="按钮名称" prop="displayText">
                    <el-input v-model="suggestButton.displayText" placeholder="请输入按钮名称" maxlength="25" show-word-limit>
                    </el-input>
                </el-form-item>
                <el-form-item label="返回数据" prop="data">
                    <el-input v-model="suggestButton.data" placeholder="请输入返回数据" maxlength="25" show-word-limit>
                    </el-input>
                </el-form-item>
                ...
                <!-- <el-form-item v-if="suggestButton.type!=4" :label="suggestButton.type==2?'URL地址':suggestButton.type==3?'联系方式':suggestButton.type==1?'关键词':''"
                    ...
                    <el-input v-model="suggestButton.text" :maxlength="suggestButton.type == 1 ? '20' : ''"
                        ...
                        stButton.type==2?'请输入URL地址':suggestButton.type==3?'请输入联系方式':'请输入关键词'"></el-input>
                </el-form-item> -->
...
<script>
    ...
    import MmsTemplateManage from '../mms/MmsTemplateManage.vue'
    export default {
        name: "TemplateDetail",
        components: {
            UploadFileBase,
        ...
        methods: {
            //删除选择的彩信内容
            mmsContentClose(tag) {
                this.mmsContent.splice(this.mmsContent.indexOf(tag), 1);
            },
            //回落数据返回以及取消
            mmsContentInfo(dialogType, mmsDialogFlag, val) {
                if (dialogType == 'cancel') {
                    this.mmsDialogFlag = mmsDialogFlag
                } else {
                    console.log(val)
                    this.mmsDialogFlag = mmsDialogFlag
                    this.mmsContent.push(val)
                }
            },
            mediaSelectResourcs() {
            ...
            onSubmit() {
                ...
                if (media) {
                    ...
                    if (this.rollback) {
                        media.fallbackSupported = 1
                        media.fallbackSupportedType = this.fallbackSupportedType
                        media.fallbackSupportedContent = this.mmsContent[0].mmsId
                    } else {
                        media.fallbackSupported = 0
                    }
                    ...
                    case 'TEMPLATE_CARD': //card
                        this.cardList.forEach((card, i) => {
                            ...
                            if (type == 'RESOURCE_IMAGE') {
                                ...
                                obj.file = this.files[i]
                            } else if (type == 'RESOURCE_AUDIO' || type == 'RESOURCE_VIDEO') {
                                obj.image = this.images[i]
                                obj.file = this.files[i]
                            }
                            obj.name = card.name
            ...
            setMedia(media) {
                ...
                if (media.fallbackSupported == 1) {
                    this.rollback = true
                    this.fallbackSupportedType = media.fallbackSupportedType
                    this.mmsContent.push({mmsId:media.fallbackSupportedContent})
        ...
        activated() {
            ...
            // if (!cache) {
                ...
                this.mmsDialogFlag = false
                this.rollback = false //回退策略
                this.fallbackSupportedType = 1
                this.mmsContent = []
                this.suggestList = []
                this.initData()
