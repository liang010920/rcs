<template>
    <section class="resource-check-video resource-check">
    ...
    export default {
        ...
        mounted() {
            let tableHeight = document.documentElement.clientHeight - 50 - 50 - 40 - 55 -
                51 - 60 - 47 - 38 +
                'px'
            document.getElementsByClassName('el-table__body-wrapper')[2].style.height = tableHeight
        },
        activated() {
            let tableHeight = document.documentElement.clientHeight - 50 - 50 - 40 - 55 -
                51 - 60 - 47 - 38 +
