    ...
    <section class="image-resource resource-manage">
        <el-form :inline="true" :model="params" size="small">
            <el-form-item label="文档名称">
                <el-input v-model="params.name" placeholder="搜索文档"></el-input>
            </el-form-item>
            ...
            <el-form-item>
                ...
                <el-button type="primary" @click="dialogVisible=true;dialogTitle='新建文档';dialogForm={groupId:catalogIdSelect}"
                    v-if="scene==1">新建文档</el-button>
            </el-form-item>
        ...
        <el-row :gutter="15" style="margin-top: 10px" class="resourceManageHeight" :style="{height:resourceManageHeight}">
            <el-col :span="6" v-for="(resource, index) in resourceList" :key="'res'+index" style="margin-bottom: 15px">
                <el-card :body-style="{ padding: '15px'}" @click.native="selectRow(resource)">
                    <i class="el-icon-folder" style="font-size: 30px;margin-bottom: 5px"></i>
                    <div class="item-desc">
                        ...
                        <div class="bottom theme-color-gray">
                            ...
                            <span class="control">
                                ...
                                <a @click.stop="previewResource(resource)" :href="resource.file | imgPath('file')"
                                    :download="resource.name"> <i class="el-icon-view"></i></a>
        ...
        <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="35%" center :close-on-click-modal="false">
            ...
            <el-form ref="form" :model="dialogForm" label-width="80px" size="small">
                ...
                <el-form-item label="内容" class="is-required">
                    ...
                    <upload-file-base v-if="dialogVisible" ref="fileUpload" accept="*/*" :limit="1" folderType="file"
                        :fileSize="500" tip="文档大小不超过500M"></upload-file-base>
        ...
        <el-dialog title="预览" :visible.sync="previewDialogVisible" width="600px" center :append-to-body="true"
            ...
            <div>
                <el-card :body-style="{ padding: '15px'}">
                    <el-image style="width: 100%;margin-bottom: 10px;" :src="preResource.image | imgPath('image')" fit="contain"></el-image>
                    <div class="item-desc">
        ...
        methods: {
            ...
            loadData() {
                ...
                if (this.currentGroup) {
                    param.catalogId = this.currentGroup.id
                }
