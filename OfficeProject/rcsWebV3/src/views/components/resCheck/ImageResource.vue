    ...
    <section class="image-resource">
        ...
        <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="35%" center :close-on-click-modal="false">
            ...
            <el-form ref="form" :model="dialogForm" label-width="80px" size="small">
                ...
                <el-form-item label="内容" class="is-required">
                    ...
                    <upload-file-base v-if="dialogVisible" ref="imageUpload"
                        accept="image/jpeg,image/png,image/bmp,image/gif" :limit="1" folderType="image" :fileSize="500"
                        tip="图片大小不超过500M，支持jpg/jepg、png、bmp、gif格式,图片大小建议：400*200"></upload-file-base>
        ...
        <div class="page-wrap">
            <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                :current-page="page.current" :page-sizes="[12, 18, 24, 30]" :page-size="page.size"
...
<script>
    ...
    export default {
        ...
        methods: {
            cancelRow(num) {
                if (num == 0) {
                    this.resParent.$emit('selectRow', num)
                } else {
