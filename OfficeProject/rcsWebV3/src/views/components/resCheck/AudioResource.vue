        ...
        <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="35%" center :close-on-click-modal="false">
            ...
            <el-form ref="form" :model="dialogForm" label-width="80px" size="small">
                ...
                <el-form-item label="内容" class="is-required">
                    <upload-file-base v-if="dialogVisible" ref="audioUpload"
                        accept="audio/3gp,audio/mp3,audio/m4a,audio/aac,audio/amr" :limit="1" folderType="audio"
                        :fileSize="500" tip="音频大小不超过500M，.3gp、.mp3、.m4a、.aac、.amr格式，最大60秒"></upload-file-base>
                </el-form-item>
                <el-form-item label="封面">

                    <upload-file-base v-if="dialogVisible" ref="audioUploadImg"
                        accept="image/jpeg,image/png,image/gif,image/bmp" :limit="1" folderType="audio" :fileSize="10"
