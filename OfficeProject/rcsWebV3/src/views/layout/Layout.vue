    ...
    <div class="layout" :class="classObj">
        ...
        <div class="header">
            ...
            <div class="right-menu">
                <el-tag effect="plain" size="mini" style="background-color: #163D66; border: 0; color: #409EFF;">
        ...
        <el-dialog
          ...
          width="60%">
          <pwd-change v-if="PwdChangeVisible" @closePwdChange="closePwdChange"></pwd-change>
        </el-dialog>
    </div>
</template>
