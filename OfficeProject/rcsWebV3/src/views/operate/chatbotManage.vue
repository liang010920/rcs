<template>
    <section class="operate-chatbot wrap-container">
        ...
        <el-table :data="chabotList" fit v-loading="tableLoading" size="small" border
            ...
            <el-table-column prop="status" label="Chatbot状态" align="center">
                <template slot-scope="scope">
                    <div v-for="item in chabotStatuList" :key="item.id" v-if="item.id==scope.row.status">{{item.name}}
                    </div>
                </template>
            </el-table-column>
            ...
            <el-table-column prop="" label="操作" align="center">
                <template slot-scope="scope">
                    ...
                    <el-button type="text" size="small" @click="upAndDown(scope.row,30)" v-if="scope.row.status==31">上线</el-button>
                    <el-button type="text" size="small" @click="upAndDown(scope.row,31)" v-if="scope.row.status==30">下线</el-button>
                    <el-button type="text" size="small" @click="cancellation(scope.row)"
                        v-if="scope.row.status==50 || scope.row.status==30 || scope.row.status==31 || scope.row.status==1 || scope.row.status==42">
                        注销</el-button>
                    <el-button type="text" size="small" @click="groundingInfo(scope.row)" v-if="scope.row.status == 50 || scope.row.status==1">
                        上架</el-button>
                    <el-button type="text" size="small" @click="whiteInfo(scope.row)" v-if="scope.row.status == 27">白名单</el-button>
                        ...
                        <el-row>
                            <el-col :span="24">
                                <el-form-item label="CSP平台 ID" prop="cspId">
                                    <el-row>
                                        <el-col :span="12">
                                            <el-select v-model="chatbotForm.cspId" placeholder="请选择CSP平台 ID"
                                                :disabled="editTitle == '新增' ? false : true">
                        ...
                        <el-row>
                            <el-col :span="24">
                                <el-form-item label="归属代理商客户编码" prop="agentCustomerNum">
                                    <el-row>
                                        <el-col :span="12">
                                            <el-select v-model="chatbotForm.agentCustomerNum" placeholder="请选择CSP平台 ID"
                                                :disabled="editTitle == '新增' ? false : true">
                        ...
                        <el-row>
                            <el-col :span="24">
                                <el-form-item label="非直签客户编码" prop="customerNum">
                                    <el-row>
                                        <el-col :span="12">
                                            <el-select v-model="chatbotForm.customerNum" placeholder="请选择客户编码"
                                                :disabled="editTitle == '新增' ? false : true">
                        ...
                        <el-row>
                            <el-col :span="24">
                                <el-form-item label="服务代码" prop="serviceCode">
                                    <el-row>
                                        <el-col :span="12">
                                            <el-input v-model="chatbotForm.serviceCode" placeholder="请输入服务代码"
                        ...
                        <el-row>
                            <el-col :span="24">
                                <el-form-item label="短信端口号" prop="sms">
                                    <el-row>
                                        <el-col :span="12">
                                            <el-input v-model="chatbotForm.sms" placeholder="请输入短信端口号" disabled
                                                maxlength="128">
                                            </el-input>
                                        </el-col>
                                        ...
                                        <el-row>
                                            <el-col :span="12">
                                                <el-select v-model="chatbotForm.extCode" placeholder="请选择扩展码">
                                                    <el-option v-for="item in serviceList" :key="item.extCode"
                                                        :label="item.extCode" :value="item.extCode">
                                                    </el-option>
                                                </el-select>
                                            </el-col>
                                            <el-col :span="12">
                            ...
                            <el-row>
                                <el-col :span="24">
                                    <el-form-item label="随机数" prop="randomNumber">
                                        <el-row>
                                            <el-col :span="12">
                                                <el-input @input="setValueNull" v-model="chatbotForm.randomNumber"
                                                    placeholder="请输入三位随机数" maxlength="3"
                        ...
                        <el-row>
                            <el-col :span="24">
                                <el-form-item label="Chatbot名称" prop="name">
                                    <el-row>
                                        <el-col :span="12">
                                            <el-input v-model="chatbotForm.name" placeholder="请输入Chatbot名称"
                                                maxlength="128">
                                            </el-input>
                                        </el-col>
                                    </el-row>
                        ...
                        <el-row>
                            <el-col :span="24">
                                <el-form-item label="实际下发行业" prop="actualIssueIndustry">
                                    <el-row>
                                        <el-col :span="12">
                                            <el-select v-model="chatbotForm.actualIssueIndustry"
                                                placeholder="请选择实际下发行业">
                                            ...
                                            <el-row>
                                                ...
                                                <el-col :span="8">
                                                    <el-select v-model="chatbotForm.provinceCode"
                                                        @change="selectAddress(chatbotForm.provinceCode)"
                                                        placeholder="请选择省市">
                                                ...
                                                <el-col :span="8">
                                                    <el-select v-model="chatbotForm.cityCode"
                                                        @change="selectCityNodeCode" placeholder="请选择地市">
                        ...
                        <el-row>
                            <el-col :span="24">
                                <el-form-item label="提供者开关" prop="providerSwitchCode">
                                    <el-row>
                                        <el-col :span="12">
                                            <el-switch v-model="chatbotForm.providerSwitchCode" active-color="#13ce66"
                        ...
                        <el-row>
                            <el-col :span="24">
                                <el-form-item label="提供者信息" prop="provider">
                                    <el-row>
                                        <el-col :span="12">
                                            <el-input v-model="chatbotForm.provider" placeholder="请输入机器人提供者信息"
                                                maxlength="128">
                                            </el-input>
                                        </el-col>
                                    </el-row>
                                    ...
                                    <el-row>
                                        <el-col :span="12">
                                            <upload-file-base v-if="editDialog" :limit="1" ref="logo" :fileSize="0.02"
                                                accept="image/jpeg,image/png,image/jpg" folderType="file"
                                                :editFile="chatbotForm.logo" tip="logo图片大小不超过20k，支持jpg/jepg、png、jpg格式">
                                            </upload-file-base>
                                        </el-col>
                                    </el-row>
                                </el-form-item>
                        ...
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="气泡颜色" prop="colour">
                                    <el-color-picker v-model="chatbotForm.colour"></el-color-picker>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                    ...
                    <el-row>
                        ...
                        <el-col :span="8">
                            <div class="detailsContent">
                                <span v-for="(item,index) in chabotStatuList" :key="index+'status'"
                                    v-if="detailsInfo.status==item.id">{{item.name}}</span>
                            </div>
                        </el-col>
                        <el-col :span="4">
        ...
        <el-dialog class="query-detail-dialog" title="固定菜单" :visible.sync="fixedMenuBool" width="70%" center
            :close-on-click-modal="false">
            <chatbot-menu v-if="fixedMenuBool" :chatbotMenuId="chatbotMenuId" chatbotOperationType="2"
                @refreshList="refreshList" @cancel="cancel"></chatbot-menu>
        </el-dialog>
        <!-- 固定菜单 end -->
    </section>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getTableListData() {
                this.chatbotForm.chatbotId = this.chatbotForm.serviceCode + this.chatbotForm.extCode + this.chatbotForm
                    .randomNumber + this.domainName
                this.chatbotForm.sms = this.chatbotForm.serviceCode + this.chatbotForm.extCode + this.chatbotForm
                    .randomNumber
            },
            //csp分组
            getCspList() {
            ...
            /* 上下线*/
            upAndDown(row,status){
                let param = {
                    chatbotId : row.chatbotId,
                    status : status
                }
                setChatbotStatus(param).then(res=>{
                    if(res.success){
                        this.$message({
                            message: 'chatbot状态修改成功',
                            type: 'success'
                        })
                        this.load()
                    }
            ...
            groundingSave() {
                ...
                testReportUrlFile.push({
                    url: this.$refs.testReportUrl.fileList[0].url,
                    name: this.$refs.testReportUrl.fileList[0].name
                })
                ...
                this.$refs.chatbotForm.validate((valid) => {
                    if (valid) {
                        ...
                        let logoArr = [],
                            backgroundImageArr = []
                        logoArr.push({
                            url: t_this.$refs.logo.fileList[0].url,
                            name: t_this.$refs.logo.fileList[0].name
                        })
                        ...
                        if (t_this.$refs.backgroundImage.fileList.length > 0) {
                            backgroundImageArr.push({
                                url: t_this.$refs.backgroundImage.fileList[0].url,
                                name: t_this.$refs.backgroundImage.fileList[0].name
                            })
